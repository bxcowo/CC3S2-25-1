...
class TestAccountModel:
    ...
    def test_to_dict(self):
        ...
        assert result["disabled"] == data["disabled"]
    ...
    def test_to_dict_with_nones(self):
        """Probar la serialización de Account a diccionario incluso con valores None"""
        data = ACCOUNT_DATA[5]
        account = Account(**data)
        account.create()
    ...
    def test_from_dict_incomplete(self):
        """Probar la deserialización de un diccionario a una instancia de Account cuando este tenga valores incompletos o incorrectos"""
        data = {
            "name": 1234,
            "disabled": True,
            "hose_number": None
